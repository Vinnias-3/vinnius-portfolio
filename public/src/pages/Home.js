...
function FeaturedCard({ project, index }) {
  ...
  useEffect(() => {
    fetch(`http://localhost:5001/api/public/pexels-images?query=${encodeURIComponent(project.category || 'technology')}&per_page=4`)
...
function NotificationsBanner({ api }) {
  ...
  useEffect(() => {
    fetch(`http://localhost:5001/api/public/notifications`)
